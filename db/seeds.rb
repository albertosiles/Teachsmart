...
resource_unknown_variable = Resource.create!(title: "Rounding", description: "Rounding to whole numbers, decimal places, nearest ten, hundred and significant figure", subject: "Mathematics", student_age: 13, category: "Arithmetic", resource_type: "Slides", user: user_Thomas)
